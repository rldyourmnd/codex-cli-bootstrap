...
- Primary tools: better-code-review skill, Serena MCP, Git diff.
- Inputs: diff scope, branch/commit references.
- Outputs: severity-ordered findings with file references.
- Hard rules: findings first, summary second.
